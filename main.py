...
if __name__ == '__main__':
    ...
    if config.mode == "all":
        ...
        local_from_folder = "C:/convert_to_pdf_3/test_from_folder"
        local_to_folder = "C:/convert_to_pdf_3/test_PDF"
        error_log_path = "C:/convert_to_pdf_3/test_log_folder/log_" + config.d + ".csv"
